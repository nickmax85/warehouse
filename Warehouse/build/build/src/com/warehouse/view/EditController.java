...
public class EditController implements Initializable {
	...
	private void handleGetArticles() {
		...
		articles.addAll(AppService.getInstance().getArticles());
	...
	private void handleDelete() {
		...
		if (selectedIndex >= 0) {
			...
			AppService.getInstance().deleteArticle(art);
	...
	public void exportToCSV() throws Exception {
		...
		try {
			...
			for (Article article : AppService.getInstance().getArticlesDistinct()) {
