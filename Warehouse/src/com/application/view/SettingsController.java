...
public class SettingsController implements Initializable {
	...
	public void setData() {
		...
		if (ApplicationProperties.getInstance().getProperty("demo").equalsIgnoreCase("true"))
			demoField.setSelected(true);
		else
			demoField.setSelected(false);
	}
	...
	private void handleOk() {
		if (isInputValid()) {
			...
			if (demoField.isSelected())
				ApplicationProperties.getInstance().edit("demo", "true");
			else
				ApplicationProperties.getInstance().edit("demo", "false");
			...
			dialogPane.getStylesheets()
					.addAll(getClass().getResource(RootLayoutController.STYLESHEET).toExternalForm());
			alert.showAndWait();
